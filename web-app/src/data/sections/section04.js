// القسم 4 — تنسيق تطبيقات React
export default {
  id: 4,
  title: "تنسيق تطبيقات React",
  level: "مبتدئ",
  lessons: [
  ...
  intro:
    "التطبيق الذي يعمل جيّد، لكن التطبيق الجميل أفضل. في هذا القسم نتعلّم طرق إضافة CSS لReact، ومتى نستخدم كلاً منها، وكيف ننظّم الأنماط مع نمو المشروع.",
  content: [
...
body {
  ...
  background: #f5f5f5;
    ...
    {
      type: "paragraph",
      text: "في المشاريع الكبيرة قد يتعارض كلاسان بنفس الاسم. وحدة CSS تجعل الأنماط محلّية لComponent واحد. سمّ الملف Something.module.css وReact يجعل أسماء الكلاسات فريدة.",
    },
    {
      type: "code",
...
function Button() {
  return <button className={styles.button}>Save</button>;
    ...
    {
      type: "tip",
      text: "استخدم وحدات CSS عندما تخصّ الأنماط Componentاً معيّناً. هذا هو الخيار الافتراضي الآمن.",
    },
...
// النتيجة: class="alert alert-success"`,
    ...
    {
      type: "paragraph",
      text: "في React، خاصية style تأخذ كائن جافاسكريبت (وليس نصاً)، وProps بصيغة camelCase. مفيدة للقيم الديناميكية مثل عرض شريط تقدّم من الحالة.",
    },
    {
      type: "code",
  ...
  .sidebar { width: 100%; }
    ...
    { type: "heading", text: "7. تنظيم الأنماط في المشاريع" },
    {
      ...
      items: [
        ...
        "أنماط Component: في وحدة CSS بجانب Component",
...
/* استخدمها: color: var(--primary); */`,
    ...
    { type: "heading", text: "✅ ملخص القسم" },
    {
      type: "list",
      items: [
        "CSS العام للأنماط الشاملة، ووحدات CSS لأنماط Component",
