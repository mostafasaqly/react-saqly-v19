...
export default {
  ...
  lessons: [
    ...
    "الهدف من هذا الكورس",
    "مرحباً بك في كورس React 19",
    "ماذا ستبني في هذا الكورس",
    "المتطلبات وخريطة الكورس",
    "نظرة عامة على React 19",
    "الجديد في React 19",
    "كيف تستفيد من هذا الكورس",
  ],
  intro:
    "أهلاً بك في الكورس! هذا القسم الأول يجهّزك للبداية. لا يوجد كود نكتبه بعد — بدلاً من ذلك سنتعرف على: ما هو React، وماذا ستبني، وما الذي تحتاج معرفته قبل البدء، وما الجديد فعلاً في React 19، وكيف تذاكر بطريقة تثبّت المعلومة.",
  content: [
    // ===== المقدمة الشخصية =====
    ...
    {
      type: "cta",
      text: "لو محتاج تدريب على مسارات متكاملة،",
    ...
    // ===== الدروس الأساسية =====
    { type: "heading", text: "1. مرحباً بك في كورس React 19" },
    { type: "subheading", text: "ما هو هذا الكورس؟" },
    {
      type: "paragraph",
      text: "هذا كورس عملي قائم على المشاريع لتعلّم React 19 — أحدث إصدار من أشهر مكتبة لبناء واجهات المستخدم في العالم. لن نقرأ نظريات فقط، بل سنكتب Components حقيقية، ونتعامل مع الحالة (state)، ونجلب بيانات حقيقية، وننفّذ ثلاثة مشاريع كاملة.",
    },
    ...
    {
      type: "paragraph",
      text: "في نهاية الكورس ستكون قد بنيت ثلاثة تطبيقات كاملة جاهزة لمعرض أعمالك (Portfolio): تطبيق إدارة مهام، ولوحة بيانات API، وStore مصغّر — بالإضافة إلى عشرات الأمثلة الصغيرة.",
    },
    {
      type: "list",
      items: [
        ...
        "🛒 المشروع الثالث: Store مصغّر — منتجات وسلّة ومفضّلات باستخدام Redux Toolkit",
      ],
    },
    ...
    {
      type: "paragraph",
      text: "لا تحتاج خبرة سابقة في React. لكنك تحتاج إلماماً مريحاً بـ HTML و CSS، والأهم جافاسكريبت الحديثة (ES6+).",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "warning",
      text: "ملاحظة صادقة: إذا كانت .map() والدوال السهمية غريبة عليك، اقضِ ساعة في جافاسكريبت الحديثة أولاً. React هو جافاسكريبت.",
    },

    { type: "heading", text: "4. نظرة عامة على React 19" },
    {
      type: "list",
      items: [
        "Components — قطع واجهة قابلة لإعادة الاستخدام تُكتب كدوال",
        "الواجهة الوصفية — تَصِف الشكل، وReact يحدّث الـ DOM",
        "تدفّق البيانات في اتجاه واحد — البيانات تنزل عبر props، والأحداث تصعد عبر callbacks",
        "Hooks — دوال خاصة مثل useState و useEffect",
      ],
    },

    { type: "heading", text: "5. الجديد في React 19" },
    { type: "subheading", text: "🎬 Actions" },
    {
      type: "paragraph",
      text: "مرّر دالة async مباشرةً إلى النموذج، وReact يدير حالات الانتظار والخطأ والنجاح نيابةً عنك.",
    },
    {
      type: "code",
  ...
  <button type="submit">Save</button>
    ...
    },
    {
      type: "list",
      items: [
        "useActionState — لإدارة حالة Action والانتظار",
        "useFormStatus — لقراءة حالة انتظار النموذج الأب",
        "useOptimistic — لعرض تحديث تفاؤلي قبل ردّ الخادم",
        "واجهة use — لقراءة الوعود وContext مع Suspense",
        "مُترجِم React — يحسّن Components تلقائياً",
      ],
    },
    {
      type: "tip",
      text: "شعار React 19: كود أقل، ووصف أكثر.",
    },
    ...
    {
      type: "tip",
      text: "القاعدة الذهبية: أفضل طريقة لإتقان React هي البناء بReact.",
    },
    ...
    { type: "heading", text: "✅ ملخص القسم" },
    {
      type: "list",
      items: [
        "React مكتبة لبناء الواجهات من Components قابلة لإعادة الاستخدام",
        "ستبني ثلاثة مشاريع كاملة",
        "تحتاج أساسيات HTML و CSS وجافاسكريبت",
        "الجديد: Actions وHooks الجديدة وواجهة use والمُترجِم",
      ],
    },
    {
      type: "qa",
      question: "1. بجملة واحدة، ما المشكلة التي يحلّها React؟",
      answer:
        "React يتيح وصف الواجهة كدالة من الحالة، ويحدّث الـ DOM بكفاءة نيابةً عنك.",
    },
    {
      type: "qa",
      question: "2. اذكر اثنين من Hooks الجديدة في React 19.",
      answer: "أي اثنين من: useActionState، useFormStatus، useOptimistic.",
    },
    {
      type: "qa",
      question: "3. ما أفضل طريقة لإتقان React؟",
      answer: "البناء بReact — الممارسة تتفوّق على القراءة.",
    },
  ],
