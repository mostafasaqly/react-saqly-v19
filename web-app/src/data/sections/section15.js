...
export default {
  ...
  lessons: [
    ...
    "معالجة نجاح API",
    "معالجة فشل API",
    "عمليات CRUD مع createAsyncThunk",
    "استخدام Axios مع Redux Toolkit",
  ...
  content: [
    ...
    { type: "heading", text: "2. فهم pending و fulfilled و rejected" },
    {
      type: "list",
      items: [
        "pending: بدأ الطلب → أظهر مؤشّر تحميل",
        "fulfilled: نجح الطلب → احفظ البيانات",
        "rejected: فشل الطلب → أظهر خطأ",
      ],
    },
  ...
  builder
    ...
    { type: "heading", text: "5. حالة isLoading" },
    {
      type: "code",
...
if (isLoading) return <p>Loading...</p>;`,
    ...
    { type: "heading", text: "6. حالة isError" },
    {
      type: "code",
      code: `.addCase(fetchUsers.rejected, (state) => { state.isError = true; })`,
    },

    { type: "heading", text: "7. حالة رسالة الخطأ" },
    {
      type: "code",
  ...
  state.message = action.error.message;
    ...
    {
      type: "tip",
      text: "isLoading + isError + message + البيانات = حالة غير متزامنة كاملة واحترافية.",
    },

    { type: "heading", text: "8. معالجة نجاح API" },
    {
      type: "code",
  ...
  state.list = action.payload;
    ...
    { type: "heading", text: "9. معالجة فشل API" },
    {
      type: "paragraph",
      text: "عند rejected: أوقف التحميل، اضبط علامة الخطأ، واحفظ الرسالة. رمي Axios على الحالة السيّئة يجعل هذا تلقائياً.",
    },

    { type: "heading", text: "10. عمليات CRUD مع createAsyncThunk" },
    {
      type: "code",
...
export const deleteUser = createAsyncThunk("users/delete", async (id) => {
  ...
  return id; // أرجِع الـ id لحذفه من المخفّض
    ...
    { type: "heading", text: "11. استخدام Axios مع Redux Toolkit" },
    {
      type: "paragraph",
      text: "Axios يناسب الـ thunks تماماً: يحلّل JSON (data جاهز للإرجاع)، ويرمي على الأخطاء فتصبح rejected تلقائياً.",
    },

    { type: "heading", text: "12. إعادة هيكلة كود Redux غير المتزامن" },
    {
      type: "list",
      items: [
    ...
    {
      type: "qa",
      question: "2. ما المراحل الثلاث التي يُرسلها createAsyncThunk؟",
