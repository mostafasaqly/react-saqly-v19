...
export default {
  ...
  intro:
    "هذا قلب React. بمجرد أن تفهم Components و JSX و props والأحداث، كل ما بعده مجرد إضافات فوقها. خذ وقتك هنا.",
  content: [
    { type: "heading", text: "1. ما هو React؟" },
    {
      type: "paragraph",
      text: "بدلاً من البحث عن كل عنصر وتحديثه يدوياً (كما في جافاسكريبت العادية)، React يتيح لك وصف شكل الشاشة لبيانات معيّنة، ويتولّى هو التحديث بسرعة وصحّة. الوحدة الأساسية هي Component: دالة جافاسكريبت تُرجع واجهة.",
    },

    { type: "heading", text: "2. كيف يعمل React" },
    { type: "subheading", text: "الـ Virtual DOM" },
    {
      type: "paragraph",
      text: "React يحتفظ بنسخة خفيفة من الصفحة في الذاكرة تُسمّى Virtual DOM. عند تغيّر الحالة: يرسم نسخة جديدة، يقارنها بالقديمة (diff)، ثم يحدّث فقط العناصر التي تغيّرت في Real DOM.",
    },
    {
      type: "code",
    ...
    {
      type: "tip",
      text: "النموذج الذهني: أنت تغيّر البيانات، وReact يحدّث الشاشة. لا تلمس الـ DOM مباشرةً.",
    },

    { type: "heading", text: "3. Components و JSX" },
    {
      type: "paragraph",
      text: "Component دالة تُرجع واجهة، واسمه يجب أن يبدأ بحرف كبير. ما بداخله يُسمّى JSX — يشبه HTML لكنه جافاسكريبت في الحقيقة.",
    },
    {
      type: "code",
  ...
  return <h1>Hello, React!</h1>;
    ...
    {
      type: "paragraph",
      text: "«العرض» يعني إظهار Component على الشاشة، تكتبه كوسم. وقوّة Components: اكتب مرة واحدة وأعد الاستخدام في أي مكان.",
    },
    {
      type: "code",
      code: `function App() {
  return (
    ...
    { type: "heading", text: "5. Props" },
    {
      type: "paragraph",
      text: "الـ props قيم تمرّرها للComponent مثل وسائط الدالة. النصوص بعلامات تنصيص، والقيم البرمجية داخل { }. الـ props للقراءة فقط — لا يغيّرها Component.",
    },
    {
      type: "code",
...
<Greeting name="Sara" age={25} />`,
    ...
    { type: "heading", text: "6. children Prop" },
    {
      type: "paragraph",
      text: "ما تضعه بين وسمي Component (الفتح والإغلاق) يصل كخاصية خاصة اسمها children. مفيدة لبناء صناديق وتخطيطات قابلة لإعادة الاستخدام.",
    },
    {
      type: "code",
...
{isLoggedIn ? <p>أهلاً</p> : <p>سجّل الدخول</p>}`,
    ...
    {
      type: "paragraph",
      text: "استخدم .map() لتحويل كل عنصر في المصفوفة إلى JSX. وكل عنصر يحتاج key فريداً ليتتبّعه React.",
    },
    {
      type: "code",
...
<button onClick={() => greet("Sara")}>تحية</button>`,
    ...
    { type: "heading", text: "10. إعادة استخدام Components" },
    {
      type: "paragraph",
      text: "هدف Components هو إعادة الاستخدام. اكتب القطعة مرة واحدة، وغيّر شكلها أو محتواها عبر props. نفس الزر يصبح «حفظ» أو «حذف» أو «إلغاء».",
    },
    {
      type: "code",
...
<Button label="حذف" color="red" onClick={remove} />`,
    ...
    {
      type: "tip",
      text: "القاعدة: إذا كتبت نفس الـ JSX مرتين، اجعله Componentاً قابلاً لإعادة الاستخدام بـ props.",
    },
    ...
    { type: "heading", text: "✅ ملخص القسم" },
    {
      type: "list",
      items: [
        "Components دوال تُرجع JSX، وأسماؤها بحرف كبير",
        "React يبني Virtual DOM، يقارنه، ويحدّث ما تغيّر فقط",
    ...
    {
      type: "qa",
      question: "1. لماذا يجب أن يبدأ اسم Component بحرف كبير؟",
      answer:
        "ليميّزه React عن وسوم HTML العادية. الأسماء الصغيرة تُعامَل كعناصر HTML.",
    },
    {
      type: "qa",
      question: "2. لماذا يحتاج كل عنصر في القائمة إلى key؟",
      answer: "ليتتبّع React كل عنصر بكفاءة ويحدّث ما تغيّر فقط.",
    },
  ],
