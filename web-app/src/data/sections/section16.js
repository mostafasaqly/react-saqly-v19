...
export default {
  ...
  lessons: [
    "أساسيات الرسم في React",
    "لماذا تعيد Components الرسم",
    "تجنّب Re-rendering غير الضرورية",
    "React.memo",
    "useMemo",
    "useCallback",
    "memo مقابل useMemo مقابل useCallback",
    "متى لا تستخدم الـ memoization",
    "نظرة عامة على مُترجِم React",
    "تقسيم الكود بالتحميل الكسول",
    "lazy و Suspense",
    "أفضل ممارسات هيكل المجلدات",
    "تصميم Components نظيف",
  ],
  intro:
    "تطبيقك يعمل — الآن لنجعله سريعاً ونظيفاً. هذا القسم يشرح لماذا يعيد React الرسم، وكيف نتجنّب العمل الزائد، وكيف يقوم مُترجِم React 19 بمعظم ذلك نيابةً عنك، وكيف تنظّم المشروع جيّداً.",
  content: [
    { type: "heading", text: "1. أساسيات الرسم في React" },
    {
      type: "paragraph",
      text: "«الرسم» يعني أن React يشغّل دالة Component لمعرفة الواجهة. الرسم رخيص عادةً. التكلفة تأتي عندما ترسم Components كثيرة كثيراً دون سبب.",
    },
    {
      type: "tip",
    ...
    { type: "heading", text: "2. لماذا تعيد Components الرسم" },
    {
      type: "list",
      items: [
        "تغيّر حالتها",
        "تغيّر Propsها (props)",
        "Re-render الأب — كل الأبناء يعيدون الرسم حتى لو لم تتغيّر props",
      ],
    },

    { type: "heading", text: "3. تجنّب Re-rendering غير الضرورية" },
    {
      type: "list",
      items: [
        "React.memo — يتخطّى Re-render Component إن لم تتغيّر props",
  ...
  console.log("clicked");
    ...
    { type: "heading", text: "7. memo مقابل useMemo مقابل useCallback" },
    {
      type: "list",
      items: [
        "memo: يغلّف Componentاً — عند props ثابتة",
    ...
    { type: "heading", text: "8. متى لا تستخدم الـ memoization" },
    {
      type: "list",
      items: [
        "إذا كان Component/الحساب رخيصاً أصلاً (معظمها كذلك)",
    ...
    { type: "heading", text: "9. نظرة عامة على مُترجِم React" },
    {
      type: "paragraph",
      text: "مُترجِم React أداة وقت بناء تقوم بكل أعمال memo/useMemo/useCallback تلقائياً. يقرأ Componentsك ويفهم الاعتماديّات ويضيف التحسين بنفسه. تكتب كوداً أبسط، والمُترجِم يجعله سريعاً.",
    },
    ...
    {
      type: "paragraph",
      text: "حمّل Component فقط عند الحاجة. قويّ جداً مع Routing: حمّل كل مسار بشكل كسول.",
    },
...
├── pages/        ← Component لكل مسار
├── features/     ← مجلدات الميزات (cart/, auth/)
├── hooks/        ← Hooks مخصّصة
├── services/     ← نداءات API
├── store/        ← Store Redux وSlices
└── utils/        ← مساعدات صغيرة`,
    },

    { type: "heading", text: "13. تصميم Components نظيف" },
    {
      type: "list",
      items: [
        "مهمّة واحدة لكل Component",
        "صغير ومركّز",
        "props للداخل، أحداث للخارج",
        "افصل المنطق عن الواجهة (Hooks مخصّصة)",
    ...
    { type: "heading", text: "✅ ملخص القسم" },
    {
      type: "list",
      items: [
        "Components تعيد الرسم عند تغيّر الحالة أو props أو الأب",
        "memo يتخطّى Componentاً، useMemo يخزّن قيمة، useCallback يخزّن دالة",
        "لا تُحسّن الرخيص — قِس أولاً",
        "مُترجِم React يؤتمت الـ memoization، و lazy يقسّم الكود",
      ],
    },
    {
      type: "qa",
      question: "1. اذكر ثلاثة أسباب لRe-render Component.",
      answer: "تغيّر حالته، أو تغيّر props، أو Re-render الأب.",
    },
    {
      type: "qa",
