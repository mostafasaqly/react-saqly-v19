...
export default {
  ...
  lessons: [
    ...
    "Hook جلب بيانات قابل لإعادة الاستخدام",
  ],
  intro:
    "معظم التطبيقات تعرض بيانات من خادم. نبدأ بـ fetch المدمج، ثم نتعلّم Axios — مكتبة شهيرة تجعل الطلبات أقصر وأنظف. وننهي بخدمات وHooks قابلة لإعادة الاستخدام.",
  content: [
...
axios.create({ baseURL: import.meta.env.VITE_API_URL });`,
    ...
    { type: "heading", text: "14. Hook جلب بيانات قابل لإعادة الاستخدام" },
    {
      type: "code",
