...
// الاستخدام:
axios.create({ baseURL: import.meta.env.VITE_API_URL });`},{type:"warning",text:"متغيّرات البيئة في الواجهة مرئية للمستخدمين — قيم عامة فقط، لا أسرار."},{type:"heading",text:"14. Hook جلب بيانات قابل لإعادة الاستخدام"},{type:"code",code:`function useFetch(url) {
