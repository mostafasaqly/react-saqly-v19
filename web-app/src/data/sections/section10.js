...
function Button() {
  ...
  return <button className={theme}>Click</button>;
    ...
    {
      type: "code",
      code: `<ThemeContext value={{ theme, toggle }}>{children}</ThemeContext>
...
const { theme, toggle } = useContext(ThemeContext);`,
  ...
  lessonsEn: [
    ...
    "Reading Context with use in React 19",
    "Custom Hooks",
    "When to Use Context and When Not To",
  ],
  introEn:
    "As an app grows, components need to share data across many levels. Passing props through every layer is tedious. This section presents cleaner approaches: composition, context, and custom hooks.",
  contentEn: [
    { type: "heading", text: "1. The Problem with Deep Prop Drilling" },
    {
      type: "paragraph",
      text: "Imagine user lives at the top of the app but only a deep component needs it. You're forced to pass it through every component in between even if they don't use it. This is called prop drilling. The two solutions: composition and context.",
    },

    { type: "heading", text: "2. Composition Pattern" },
    {
      type: "paragraph",
      text: "Sometimes you don't need context — just pass JSX as children. Instead of a component creating its deep child, the parent passes it down.",
    },
    {
      type: "code",
      code: `function App() {
...
// Layout doesn't need to know about user at all`,
    ...
    { type: "heading", text: "3. The Context API" },
    {
      type: "paragraph",
      text: "Some data is needed in many places: current user, theme, language. Context is like a broadcast: one component 'provides' a value, and any component below 'reads' it directly. Three steps: create, provide, read.",
    },

    { type: "heading", text: "4. Creating a Context" },
    {
      type: "code",
      code: `import { createContext } from "react";
export const ThemeContext = createContext("light");`,
    ...
    { type: "heading", text: "5. Providing a Context" },
    {
      type: "code",
      code: `<ThemeContext value="dark">
  <Page />
    ...
    {
      type: "tip",
      text: "In React 19 you use <ThemeContext value={...}> directly. (The old <ThemeContext.Provider> syntax still works too.)",
    },

    { type: "heading", text: "6. Reading Context with useContext" },
    {
      type: "code",
      code: `import { useContext } from "react";
...
function Button() {
  ...
  return <button className={theme}>Click</button>;
    ...
    { type: "heading", text: "7. Updating Context Data" },
    {
      type: "paragraph",
      text: "Context can carry both data and a function to change it. Put useState in the provider, then share both the value and the setter.",
    },
    {
      type: "code",
      code: `<ThemeContext value={{ theme, toggle }}>{children}</ThemeContext>
...
const { theme, toggle } = useContext(ThemeContext);`,
    ...
    { type: "heading", text: "8. Practical Context Example" },
    {
      type: "paragraph",
      text: "A theme that any component can read and toggle. The provider owns theme state and a toggle function, and provides { theme, toggle } to everything inside. This is how real apps handle theme, user, and language.",
    },

    { type: "heading", text: "9. Reading Context with use in React 19" },
    {
      type: "paragraph",
      text: "React 19 adds use. For context it works like useContext, but can be called conditionally — inside an if for example. Regular hooks can't do that.",
    },
    {
      type: "code",
      code: `if (showThemed) {
  ...
  return <button className={theme}>Themed</button>;
    ...
    { type: "heading", text: "10. Custom Hooks" },
    {
      type: "paragraph",
      text: "A custom hook is a function whose name starts with use and calls other hooks. It lets you reuse logic.",
    },
    {
      type: "code",
      code: `function useLocalStorage(key, initialValue) {
  ...
  return [value, setValue];
    ...
    { type: "heading", text: "11. When to Use Context and When Not To" },
    {
      type: "list",
      items: [
        "✅ For global data that changes slowly: theme, user, language",
        "❌ If only a few nearby components need it — lift state up instead",
        "❌ If it changes frequently (every keystroke) — re-renders all readers",
        "❌ For complex global state — use Redux Toolkit (Section 14)",
      ],
    },
    ...
    { type: "heading", text: "✅ Section Summary" },
    {
      ...
      items: [
        ...
        "Composition (children) eliminates a lot of drilling",
        "Context: create → provide → read",
        "use reads context conditionally; custom hooks reuse logic",
      ],
    },
    {
      type: "qa",
      question: "1. What are the three steps for using context?",
      answer: "Create (createContext), provide (<Context value>), read (useContext).",
    },
    {
      type: "qa",
      question: "2. Name a situation where context is the wrong tool.",
      answer: "When data changes frequently, or when you need complex global state — use state lifting or Redux.",
    },
  ],
};
